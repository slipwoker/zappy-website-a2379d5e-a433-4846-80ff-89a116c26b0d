    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: 'a2379d5e-a433-4846-80ff-89a116c26b0d',
            name: name,
            email: email,
            subject: service || 'Contact Form Submission',
            message: message + (company ? '\n\nחברה: ' + company : '') + (service ? '\n\nשירות: ' + service : ''),
            phone: phone || null
          };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קרטיב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
